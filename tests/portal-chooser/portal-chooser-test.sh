...
#                                  and does not hang
#   3. portal not installed     -> pins the behaviour actually measured, which is
#                                  NOT the one the source comment claims
#
...
# This is a PIN on measured behaviour, not on desired behaviour. src-tauri/src/lib.rs
