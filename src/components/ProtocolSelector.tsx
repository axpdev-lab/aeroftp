...
const PROTOCOLS_FALLBACK: ProtocolInfo[] = [
    ...
    { type: 'proton', name: 'Proton Drive', icon: <ProtonDriveLogo size={18} />, description: 'Proton Drive via official CLI', defaultPort: 443, badge: 'CLI', color: 'text-slate-500', isCloudStorage: true, tooltip: 'Official Proton Drive CLI (user-installed, browser sign-in)' },
