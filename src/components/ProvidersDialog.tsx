...
import { findCatalogByLogo, findCatalogByProviderId, hasFreeTier, isDevOnlyProvider } from './providerCatalog';
...
const ALL_PROVIDERS: ProviderFeatures[] = [
  ...
  // ── Media / Photo Cloud ──
  { name: 'Immich', logoId: 'immich', section: 'Media',
    base: ['upload', 'download', 'delete', 'mkdir', 'search', 'shareLink'],
    advanced: ['checksum'] },
  { name: 'PixelUnion', logoId: 'pixelunion',
    base: ['upload', 'download', 'delete', 'mkdir', 'search', 'shareLink'],
    advanced: ['checksum'] },
  { name: 'Google Photos', logoId: 'googlephotos',
    base: ['upload', 'download', 'mkdir'],
    advanced: [] },
  { name: 'ImageKit', logoId: 'imagekit',
    base: ['upload', 'download', 'delete', 'rename', 'move', 'mkdir', 'search'],
    advanced: [] },
  { name: 'Uploadcare', logoId: 'uploadcare',
    base: ['upload', 'download', 'delete', 'shareLink'],
    advanced: [] },
  { name: 'Cloudinary', logoId: 'cloudinary',
    base: ['upload', 'download', 'delete', 'rename', 'mkdir', 'search', 'shareLink'],
    advanced: [] },
