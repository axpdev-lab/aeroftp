...
const CLOUD_SERVICES: DiscoverItem[] = [
    ...
    { id: 'twake', name: 'Twake Drive', description: 'Linagora Twake Workplace drive, formerly Cozy Cloud (5 GB free, EU)', protocol: 'twake', badge: 'OAuth', signupUrl: 'https://twake.app', source: 'protocol' },
