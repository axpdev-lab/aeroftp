...
const CLOUD_SERVICES: DiscoverItem[] = [
    ...
    { id: 'proton', name: 'Proton Drive', description: 'E2E encrypted cloud via the Proton Drive CLI', protocol: 'proton', badge: 'CLI', signupUrl: 'https://proton.me/drive', healthCheckUrl: 'https://drive-api.proton.me', source: 'protocol' },
    ...
    { id: 'drime', name: 'Drime', description: 'Cloud storage with API access (20 GB free)', protocol: 'drime', badge: 'API', signupUrl: 'https://drime.cloud', healthCheckUrl: 'https://app.drime.cloud', source: 'protocol' },
    { id: 'twake', name: 'Twake Drive', description: 'Linagora Twake Workplace drive, now home of Cozy Cloud (5 GB free, EU)', protocol: 'twake', badge: 'OAuth', signupUrl: 'https://twake.app', source: 'protocol' },
...
const MEDIA_SERVICES: DiscoverItem[] = [
    ...
    { id: 'uploadcare', name: 'Uploadcare', description: 'EU media management with CDN (1 GB free)', protocol: 'uploadcare' as ProviderType, providerId: 'uploadcare', badge: 'EU', signupUrl: 'https://uploadcare.com/accounts/signup/', helpUrl: 'https://uploadcare.com/docs/start/settings/', healthCheckUrl: 'https://api.uploadcare.com', source: 'protocol' },
...
export const PROVIDER_HEALTH_URLS: Partial<Record<ProviderType, string>> = {
    ...
    proton: 'https://drive-api.proton.me',
