...
const CLOUD_SERVICES: DiscoverItem[] = [
    ...
    { id: 'proton', name: 'Proton Drive', description: 'E2E encrypted cloud via the official Proton Drive CLI', protocol: 'proton', badge: 'CLI', signupUrl: 'https://proton.me/drive', healthCheckUrl: 'https://drive-api.proton.me', source: 'protocol' },
