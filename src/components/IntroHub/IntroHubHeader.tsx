...
interface IntroHubHeaderProps {
    ...
    /** Drag-to-reorder the form tabs (#347): called with the reordered
     *  array after a drop, same contract as SessionTabs' `onReorder`. When
     *  omitted the tabs are not draggable. */
...
export function IntroHubHeader({
    ...
    // Drag-to-reorder state for the form tabs (#347): the same HTML5-DnD
    // approach the '🟢 Active Sessions' strip uses in SessionTabs — a dragged
    // index, a drop-target index for the insertion marker, and a node ref to
    // dim the dragged chip for the duration of the drag.
    ...
    return (
        <div className="aero-tabstrip flex items-center gap-1 p-2 bg-white/50 dark:bg-gray-800/80 backdrop-blur-sm border-b border-gray-200 dark:border-gray-700 rounded-t-lg overflow-hidden">
