...
export const PROVIDER_CATALOG: CatalogCompany[] = [
    ...
    { company: 'InfiniCloud', logoId: 'infinicloud', countryCode: 'JP', freeStorageGb: 25,
    ...
    { company: 'Twake Drive', parentCompany: 'Linagora', logoId: 'twake', countryCode: 'FR', freeStorageGb: 5,
      protocols: [{ label: 'OAuth', protocol: 'twake', category: 'cloud-storage' }],
      searchAliases: ['cozy', 'cozy cloud', 'twake workplace'] },
    ...
    { company: 'IBM Cloud Object Storage', parentCompany: 'IBM', logoId: 'ibm-cos', countryCode: 'US', freeStorageGb: null,
      freeNote: '12-month trial',
      healthCheckUrl: 'https://s3.eu-de.cloud-object-storage.appdomain.cloud',
      searchAliases: ['ibm', 'ibm cloud', 'ibm cos'],
      protocols: [{ label: 'S3', protocol: 's3', providerId: 'ibm-cos', category: 'object-storage', paid: true }] },
...
export const PROVIDER_GRID: readonly ProviderGridTile[] = [
    ...
    { logoId: 'twake', icon: 'twake.png', docsPath: 'providers/twake' },
